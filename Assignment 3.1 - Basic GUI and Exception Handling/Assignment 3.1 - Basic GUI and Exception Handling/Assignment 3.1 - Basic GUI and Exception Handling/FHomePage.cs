...
namespace Assignment_3._1___Basic_GUI_and_Exception_Handling
{
    ...
    {
        // The following Code stores the user's input for their name so it is searchable to other forms
        ...
        private void BTNBudgetStrat_Click(object sender, EventArgs e)
        {
            ...
            FBudgetStrategy budgetStrategyForm = new FBudgetStrategy(this);
        ...
        private void BTNTakeHomeP_Click(object sender, EventArgs e)
        {
            ...
            FTakeHomePay takeHomePayForm = new FTakeHomePay(this);
        ...
        private void BTNDebtStrategy_Click(object sender, EventArgs e)
        {
            ...
            FDebtStrategy debtStrategyForm = new FDebtStrategy(this);
